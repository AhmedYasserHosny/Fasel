...
<br><br><br><br>
        ...
        <section class="container content-section">
            ...
            <div class="shop-items">
                <div class="shop-item">
                    <span class="shop-item-title">R32</span>
                    <img class="shop-item-image" src="img/a1.jpg">
                    <div class="shop-item-details">
                        <span class="shop-item-price">$73.36</span>
                        <button class="btn btn-primary addtocart" type="button">ADD TO CART</button>
                    </div>
                </div>
                <div class="shop-item">
                    <span class="shop-item-title">R27</span>
                    <img class="shop-item-image" src="img/a2.jpg">
                    <div class="shop-item-details">
                        <span class="shop-item-price">$112.63</span><br><br>
                        <button class="btn btn-primary addtocart"type="button">ADD TO CART</button>
                    </div>
                </div>
                <div class="shop-item">
                    <span class="shop-item-title">R32.254</span>
                    <img class="shop-item-image" src="img/a3.jpg">
                    <div class="shop-item-details">
                ...
                <div class="shop-item">
                    <span class="shop-item-title">R30</span>
                    <img class="shop-item-image" src="img/a4.jpg">
                    <div class="shop-item-details">
                ...
                <div class="shop-item">
                  <span class="shop-item-title">R27.086</span>
                  <img class="shop-item-image" src="img/a5.jpg">
                  <div class="shop-item-details">
              ...
              <div class="shop-item">
                <span class="shop-item-title">R32.127.16</span>
                <img class="shop-item-image" src="img/r6.png">
                <div class="shop-item-details">
                    <span class="shop-item-price">$135.79</span>
                    <button class="btn btn-primary addtocart" type="button">ADD TO CART</button>
                </div>
            </div>
            </div>
