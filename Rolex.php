...
<br><br><br><br>
        ...
        <section class="container content-section">
            ...
            <div class="shop-items">
                <div class="shop-item">
                    <span class="shop-item-title">Rolex Milgauss</span>
                    <img class="shop-item-image" src="img/r1.jpg">
                    <div class="shop-item-details">
                        <span class="shop-item-price">$69.59</span>
                        <button class="btn btn-primary addtocart" type="button">ADD TO CART</button>
                    </div>
                </div>
                <div class="shop-item">
                    <span class="shop-item-title">Sea-Dweller</span>
                    <img class="shop-item-image" src="img/r2.jpg">
                    <div class="shop-item-details">
                        <span class="shop-item-price">$75.59</span><br><br>
                        <button class="btn btn-primary addtocart"type="button">ADD TO CART</button>
                    </div>
                </div>
                <div class="shop-item">
                    <span class="shop-item-title">Datejust II</span>
                    <img class="shop-item-image" src="img/r3.png">
                    <div class="shop-item-details">
                        <span class="shop-item-price">$46.99</span>
                        <button class="btn btn-primary addtocart" type="button">ADD TO CART</button>
                    </div>
                </div>
                <div class="shop-item">
                    <span class="shop-item-title"> Daytona </span>
                    <img class="shop-item-image" src="img/r4.png">
                    <div class="shop-item-details">
                ...
                <div class="shop-item">
                  <span class="shop-item-title">Daytona Gold</span>
                  <img class="shop-item-image" src="img/r5.jpg">
                  <div class="shop-item-details">
                      <span class="shop-item-price">$108.99</span>
                      <button class="btn btn-primary addtocart" type="button">ADD TO CART</button>
                  </div>
              </div>
              <div class="shop-item">
                <span class="shop-item-title"> Air-King</span>
                <img class="shop-item-image" src="img/r6.png">
                <div class="shop-item-details">
                    <span class="shop-item-price">$77.99</span>
                    <button class="btn btn-primary addtocart" type="button">ADD TO CART</button>
                </div>
            </div>
            </div>
