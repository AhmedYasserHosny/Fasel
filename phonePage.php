        ...
        <section class="container content-section">
            ...
            <div class="shop-items">
                <div class="shop-item">
                    ...
                    <img class="shop-item-image" src="img/LD0005886456_1_0005886482_0005886533.jpg">
                ...
                <div class="shop-item">
                    ...
                    <img class="shop-item-image" src="img/i12.jpg">
                    <div class="shop-item-details">
                ...
                <div class="shop-item">
                    ...
                    <img class="shop-item-image" src="img/nokia.jpg">
                    <div class="shop-item-details">
                ...
                <div class="shop-item">
                    ...
                    <img class="shop-item-image" src="img/download.jpg">
                    <div class="shop-item-details">
                ...
                <div class="shop-item">
                  <span class="shop-item-title">nokia 3310</span>
                  <img class="shop-item-image" src="img/42122-Nokia-6600.jpg">
                  <div class="shop-item-details">
                      <span class="shop-item-price">$9.99</span>
                      <button class="btn btn-primary addtocart" type="button">ADD TO CART</button>
                  </div>
              ...
              <div class="shop-item">
                ...
                <img class="shop-item-image" src="img/download (1).jpg">
                <div class="shop-item-details">
                    <span class="shop-item-price">$9.99</span>
                    <button class="btn btn-primary addtocart" type="button">ADD TO CART</button>
                </div>
