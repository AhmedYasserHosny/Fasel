...
<body>
  ...
  <div id="carouselExampleIndicators" class="carousel slide text-center background" data-bs-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active img-1">
        <img src="img/6.jpg" class="img-fluid w-50"
          alt="...">
      </div>
  ...
  <!---------------------------------------#categories----------------------------------------------------------->
  <br>
  <h1 class="title animate__animated animate__bounce animate__delay-0.5s animate__infinite	infinite"> admin dashboard</h1>
  <BR></BR> <br>
  <div class="container-fluid">
  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-lg-6 phone">
        <a href="Updateitem.php"> <img src="img/update.png" alt=""></a>
        <br><br>
        <h3> update item </h3>
      </div>
      <div class="col-lg-1"></div>
      <div class="col-lg-5 car">
        <a href="Additem.php"> <img src="img/add.jfif" alt=""></a>
        <br><br>
        <h3> add item </h3>
      </div>
      <div class="col-lg-1"></div>
...
<br>
  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-lg-6 phone">
        <a href="allitems.php"> <img src="img/all.png" alt=""></a>
        <br><br>
        <h3> all item </h3>
      </div>
      <div class="col-lg-1"></div>
      <div class="col-lg-5 car">
        <a href="deleteitem.php"> <img src="img/delete.jfif" alt=""></a>
        <br><br>
        <h3> delete item </h3>
      </div>
      <div class="col-lg-1"></div>
