...
<br><br><br><br>
        ...
        <section class="container content-section">
            ...
            <div class="shop-items">
                <div class="shop-item">
                    <span class="shop-item-title">G-Shock</span>
                    <img class="shop-item-image" src="img/g.jpg">
                ...
                <div class="shop-item">
                    <span class="shop-item-title">Ediefice</span>
                    <img class="shop-item-image" src="img/c2.jpg">
                    <div class="shop-item-details">
                        <span class="shop-item-price">$119.99</span><br><br>
                        <button class="btn btn-primary addtocart"type="button">ADD TO CART</button>
                    </div>
                </div>
                <div class="shop-item">
                    <span class="shop-item-title">Classic 1 </span>
                    <img class="shop-item-image" src="img/c3.jpg">
                    <div class="shop-item-details">
                ...
                <div class="shop-item">
                    ...
                    <img class="shop-item-image" src="img/d.png">
                    <div class="shop-item-details">
                ...
                <div class="shop-item">
                  <span class="shop-item-title">Ediefice 2</span>
                  <img class="shop-item-image" src="img/E3.jpg">
                  <div class="shop-item-details">
                      <span class="shop-item-price">$98.99</span>
                      <button class="btn btn-primary addtocart" type="button">ADD TO CART</button>
                  </div>
              </div>
              <div class="shop-item">
                <span class="shop-item-title">Ediefice 3</span>
                <img class="shop-item-image" src="img/E4.png">
                <div class="shop-item-details">
                    <span class="shop-item-price">$89.99</span>
                    <button class="btn btn-primary addtocart" type="button">ADD TO CART</button>
                </div>
