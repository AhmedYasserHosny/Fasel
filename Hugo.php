...
<br><br><br><br>
        ...
        <section class="container content-section">
            ...
            <div class="shop-items">
                <div class="shop-item">
                    <span class="shop-item-title">Black Dial</span>
                    <img class="shop-item-image" src="img/h1.png">
                    <div class="shop-item-details">
                        <span class="shop-item-price">$40.59</span>
                        <button class="btn btn-primary addtocart" type="button">ADD TO CART</button>
                    </div>
                </div>
                <div class="shop-item">
                    <span class="shop-item-title">Blue Dial</span>
                    <img class="shop-item-image" src="img/h2.png">
                    <div class="shop-item-details">
                        <span class="shop-item-price">$60.59</span><br><br>
                        <button class="btn btn-primary addtocart"type="button">ADD TO CART</button>
                    </div>
                </div>
                <div class="shop-item">
                    <span class="shop-item-title">Blue Dial 2 </span>
                    <img class="shop-item-image" src="img/h3.png">
                    <div class="shop-item-details">
                        <span class="shop-item-price">$86.99</span>
                        <button class="btn btn-primary addtocart" type="button">ADD TO CART</button>
                    </div>
                </div>
                <div class="shop-item">
                    <span class="shop-item-title">Gold toned</span>
                    <img class="shop-item-image" src="img/h4.jpg">
                    <div class="shop-item-details">
                ...
                <div class="shop-item">
                  <span class="shop-item-title">Black-plated</span>
                  <img class="shop-item-image" src="img/h5.jpg">
                  <div class="shop-item-details">
              ...
              <div class="shop-item">
                <span class="shop-item-title">Black-plated chronograph </span>
                <img class="shop-item-image" src="img/h6.jpg">
                <div class="shop-item-details">
